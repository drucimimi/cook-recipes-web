...
const Home = () => {
    ...
    return (
    <>
      <Header icon={logo} iconReverse={logoReverse} iconDescription={"Logo Recipes App"} title={"Recipes App"} />
      <main className="flex flex-col items-center justify-center flex-1 px-20 pt-10 pb-36 text-center">
        <h1 className="text-6xl font-bold light:text-gray-800 dark:text-white-800">
          Bienvenue sur <span className="text-green-500">Cook Recipes App</span>
        </h1>
        <p className="mt-3 text-2xl light:text-gray-600 dark:text-white-600">
           Application en cours de déploiement sur Play Store. Patientez encore un peu ...
        </p>
        {/* <p className="mt-3 text-2xl light:text-gray-600 dark:text-white-600">
           Téléchargez notre application mobile dès maintenant sur Play Store !
        </p>
        <div className="flex flex-col lg:flex-row gap-2">
          <ButtonLink source={`#`} name="Télécharger l'application Android" action='Télécharger' icon={iconAPK} iconReverse={iconAPKReverse} iconDescription='Icone Android' />
        </div> */}
      </main>
      <Footer />
    </>
